...
if (!pepper)
    throw new Error('ENV variable "BCRYPT_PASSWORD" not specified.');
if (isNaN(saltRounds))
...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, bcrypt_1["default"].hash(user.password + pepper, saltRounds)];
                    case 2:
                        hash = _a.sent();
    ...
    UserStore.check_pass = function (user, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bcrypt_1["default"].compare(password + pepper, user.password)];
