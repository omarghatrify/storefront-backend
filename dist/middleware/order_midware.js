...
exports.orderOwner = exports.orderParam = void 0;
var order_model_1 = require("../models/order_model");
var orderParam = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var order_id, order, error_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (isNaN(order_id)) {
                    res
                        .status(400)
                        .json("Failed to get order products, " + new Error('Invalid order id.'));
                    return [2 /*return*/];
                }
            ...
            case 2:
                error_1 = _a.sent();
                res.status(500);
                res.json("Failed to get order, " + error_1);
                return [3 /*break*/, 3];
...
var orderOwner = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, order;
    return __generator(this, function (_a) {
        try {
